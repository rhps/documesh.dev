...
- When the user asks about any developer documentation topic
- When the user needs API usage, configuration, or best practices
- When the user asks about a specific vendor's features (Cloudflare, Netlify, Vercel, Kubernetes, React, PyTorch, etc.)
